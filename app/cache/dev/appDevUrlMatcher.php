...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/categorie') {
            return array (  '_controller' => 'Suivi\\SuiviBundle\\Controller\\CategorieController::sendAction',  '_route' => 'suivi_vente_categ',);
        }

        // suivi_vente_list_categ
        if ($pathinfo === '/list_categ') {
            return array (  '_controller' => 'Suivi\\SuiviBundle\\Controller\\CategorieController::listAction',  '_route' => 'suivi_vente_list_categ',);
        }
